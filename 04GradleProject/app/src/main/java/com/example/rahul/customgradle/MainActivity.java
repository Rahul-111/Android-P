package com.example.rahul.customgradle;
    ...
    public void showToast(View view){
        switch (view.getId()){
            ...
            case R.id.warningButton:
                Toasty.warning(this,"OOPs! Warning",Toast.LENGTH_SHORT).show();
                break;
            case R.id.imageButton:
                Toasty.normal(this,"Upload down",Toast.LENGTH_SHORT,ContextCompat.getDrawable(this,R.drawable.ic_cloud)).show();
                break;
        }
    }
}
